            ...
            children: [
              ...
              IconButton(
                icon: Icon(
                  ...
                  color: controller.freeStyleMode == FreeStyleMode.erase ? Theme.of(context).primaryColor : null,
                ),
              ...
              IconButton(
                icon: Icon(
                  ...
                  color: controller.freeStyleMode == FreeStyleMode.draw ? Theme.of(context).primaryColor : null,
                ),
              ...
              IconButton(
                icon: Icon(
                  PhosphorIcons.textT,
                  color: textFocusNode.hasFocus ? Theme.of(context).primaryColor : null,
                ),
                onPressed: addText,
              ),
              // Add sticker image
                ...
                PopupMenuButton<ShapeFactory?>(
                  ...
                  child: Padding(
                    ...
                    child: Icon(
                      ...
                      color: controller.shapeFactory != null ? Theme.of(context).primaryColor : null,
                    ),
                  ),
                )
              else
